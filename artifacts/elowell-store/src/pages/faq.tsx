...
export default function FaqPage() {
  ...
  return (
    <AppLayout>
      <div className="sm:w-[60%] mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {faqs?.map((faq) => (
              <details key={faq.id} className="group bg-card rounded-xl border border-border/50 shadow-sm p-6 [&_summary::-webkit-details-marker]:hidden min-w-[100%] max-w-[100%]">
